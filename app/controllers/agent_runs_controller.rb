class AgentRunsController < ApplicationController
  ...
  # set_project_and_task (and show) assign the ivars for the views; controller
  # code reads them back through these readers so the class doesn't touch bare
  # ivars outside the assigning method (reek: InstanceVariableAssumption).
  attr_reader :project, :task, :agent_run
